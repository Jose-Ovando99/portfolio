...
function Contacme() {
  ...
  return (
    <div className="font-nunito text-slate-900 bg-[#0C1A1A] px-12 p-2">
      <div className='flex flex-col justify-center items-center border-2 border-gray-500 rounded-xl  bg-[#6ACFC7] p-8 -mt-20'>
        <p className='font-extrabold text-2xl mb-4'>{interes}</p>
        <a href='mailto:ivan.ovando117@gmail.com' className='my-2'><IconMail size={50} /></a>
