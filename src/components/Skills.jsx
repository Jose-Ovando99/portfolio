...
function Skills() {
  ...
  return (
    <div className="text-2xl font-nunito text-slate-900 bg-slate-200 flex flex-col md:flex-row px-12 text-center justify-center pb-20 dark:bg-slate-900">
      <div className='border-2 md:border-r rounded-xl rounded-b-none border-gray-500 bg-slate-200 -mt-40 p-8 md:rounded-xl md:w-2/5 dark:border-slate-200 dark:bg-slate-900 dark:text-slate-200'>
      ...
      <div className='border-2 md:border-l rounded-xl rounded-t-none border-gray-500 bg-slate-200 -mt-1 md:-mt-40 md:rounded-xl p-8 md:w-2/5 dark:border-slate-200 dark:bg-slate-900 dark:text-slate-200'>
